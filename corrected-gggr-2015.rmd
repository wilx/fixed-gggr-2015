...
````{r, echo=FALSE, fig.align='center'}
indexes <- data.frame(final = finalIndex$index, original = originalIndex$index)
frame()
ggplot(indexes) +
  geom_histogram(aes(final, fill=index), color="green", fill="green", alpha = 0.70, binwidth = 0.025) +
  geom_histogram(aes(original, fill=index), color="blue", fill="blue", alpha = 0.5, binwidth = 0.025) +
