...
:   Subindex is a weigted average of various female to male ratios.
...
:   Please consult the orignal [GGGR](http://reports.weforum.org/global-gender-gap-report-2015/)
...
finalIndex <- sqldf("SELECT country,
                         ((COALESCE(subIndexEcon.subindex, 0)
                          ...
                          / 4.0) AS [index],
                          subIndexEcon.rank AS [econ.R],
                          subIndexEcon.subindex AS [econ.SI],
                          subIndexEdu.rank AS [edu.R],
                          subIndexEdu.subindex AS [edu.SI],
                          subIndexHealth.rank AS [he.R],
                          subIndexHealth.subindex AS [he.SI],
                          subIndexPol.rank AS [pol.R],
                          subIndexPol.subindex AS [pol.SI]
                      FROM subIndexEcon
                      JOIN subIndexEdu USING (country)
                      JOIN subIndexHealth USING (country)
                      JOIN subIndexPol USING (country)")
finalIndex <- finalIndexTweak(finalIndex)[c(1, 11, 2, 3, 4, 5, 6, 7, 8, 9, 10)]
